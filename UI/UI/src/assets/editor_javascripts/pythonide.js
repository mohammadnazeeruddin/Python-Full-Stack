...
// import '../editor_javascripts/skulpt.min.js';
import CodeMirror from '../editor_javascripts/codemirror.js';
import '../editor_javascripts/skulpt-stdlib.js';
import '../editor_javascripts/python.js'
...
export var runit = function () { };

// Clears the output (both text and graphical)
export var clearit = function () { };

// Sets the contents of the editor to program
export var setProgram = function (_program) { }

// Returns the contents of the editor
export var getProgram = function () { }

// The codemirror editor
export var editor;
export var outf = function () { }
// 
...
//
export function setupPythonIDE(codeId, outputId, canvasId) {
    ...
    // Here's everything you need to run a python program by pythonguru,it's available soon!
