                    ...
                    <div class="card b">
                        ...
                        <div class="list-group">
                            <button type="button" class="list-group-item list-group-item-action"
                                ...
                                @click="toggleTab('profile')">Profile</button>
                            <button type="button" class="list-group-item list-group-item-action"
                                :class="this.activeTab === 'account' ? 'active':''"
                                @click="toggleTab('account')">Account</button>
                            <button type="button" class="list-group-item list-group-item-action"
                                :class="this.activeTab === 'emails' ? 'active':''"
                                @click="toggleTab('emails')">Emails</button>
                            <button type="button" class="list-group-item list-group-item-action"
                                :class="this.activeTab === 'notifications' ? 'active':''"
                                @click="toggleTab('notifications')">Notifications</button>
                            <button type="button" class="list-group-item list-group-item-action"
                                :class="this.activeTab === 'applications' ? 'active':''"
                                @click="toggleTab('applications')">Applications</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-9">
